...
namespace WebEcoMVC.Controllers
{
    ...
    {
        private readonly EcoMvcContext _context;

        public HangHoasController(EcoMvcContext context)
        {
            _context = context;
        }
        ...
        {
            var ecoMvcContext = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
            return View(await ecoMvcContext.ToListAsync());
        }
